...
const Resume = () => {
    return (
        <motion.section
            ...
            <motion.p variants={fadeUp} className='mt-3 text-neutral-400'>
            ...
            <div className="grid gap-x-10 my-16 md:grid-cols-2">
                ...
                <motion.div
                    ...
                    <h2 className="text-3x1 font-semibold mt-8">Educación</h2>
                    <div className="space-y-0 border-1 border-neutral-700 pl-6 mt-4">
                ...
                <motion.div
                    variants={fadeUp}>
                    <h2 className="text-3x1 font-semibold mt-8">Experencia Profecional</h2>
                    <div className="space-y-0 border-1 border-border pl-6 mt-4">
